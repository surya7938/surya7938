...
<html>
  ...
  <body>
   <%
    	String target="DoctorChangepassword.jsp?status=Password Changed Failed";
            ...
            boolean flag=new SecurityDAO().changePassword1(rb); 
             
            if(flag) 
                target="DoctorChangepassword.jsp?status=Password Changed Successfully"; 
